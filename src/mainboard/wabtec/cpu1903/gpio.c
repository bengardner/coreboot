...
static const struct soc_gpio_map gpncore_gpio_map[] = {
	GPIO_FUNC2,				/* GPIO_S0_NC[00] - HV_DDI0_HPD */
	GPIO_FUNC2,				/* GPIO_S0_NC[01] - HV_DDI0_DDC_SDA */
	GPIO_FUNC2,				/* GPIO_S0_NC[02] - HV_DDI0_DDC_SCL */
	GPIO_NC,				/* GPIO_S0_NC[03] - No Connect (PANEL0_VDDEN) */
	GPIO_NC,				/* GPIO_S0_NC[04] - No Connect (PANEL0_BKLTEN) */
	GPIO_NC,				/* GPIO_S0_NC[05] - No Connect (PANEL0_BKLTCTL) */
	GPIO_FUNC2,				/* GPIO_S0_NC[06] - DDI1_HPD */
	GPIO_FUNC2,				/* GPIO_S0_NC[07] - DDI1_DDCDAT */
	GPIO_FUNC2,				/* GPIO_S0_NC[08] - DDI1_DDCCLK */
	GPIO_NC,				/* GPIO_S0_NC[09] - No Connect (PANEL1_VDDEN) */
	GPIO_NC,				/* GPIO_S0_NC[10] - No Connect (PANEL1_BKLTEN) */
	GPIO_NC,				/* GPIO_S0_NC[11] - No Connect (PANEL1_BKLTCTL) */
	GPIO_FUNC0_PU_20K,			/* GPIO_S0_NC[12] - No Connect (GP_INTD_DSI_TE1) */
	GPIO_NC,				/* GPIO_S0_NC[13] - No Connect (HV_DDI2_DDC_SDA) */
	GPIO_NC,				/* GPIO_S0_NC[14] - No Connect (HV_DDI2_DDC_SCL) */
	GPIO_FUNC2,//INPUT_PU_20K,			/* GPIO_S0_NC[15] - XDP_OBSFN_C0 */
	GPIO_FUNC2,//INPUT_PU_20K,			/* GPIO_S0_NC[16] - XDP_OBSDATA_C0 */
	GPIO_FUNC2,//INPUT_PU_20K,			/* GPIO_S0_NC[17] - XDP_OBSDATA_C1 */
	GPIO_FUNC2,//INPUT_PU_20K,			/* GPIO_S0_NC[18] - XDP_OBSDATA_C2 */
	GPIO_FUNC2,//INPUT_PU_20K,			/* GPIO_S0_NC[19] - XDP_OBSDATA_C3 */
	GPIO_FUNC2,//INPUT_PU_20K,			/* GPIO_S0_NC[20] - XDP_OBSDATA_D0 */
	GPIO_FUNC2,//INPUT_PU_20K,			/* GPIO_S0_NC[21] - XDP_OBSDATA_D1 */
	GPIO_FUNC2,//INPUT_PU_20K,			/* GPIO_S0_NC[22] - XDP_OBSDATA_D2 */
	GPIO_FUNC2,//INPUT_PU_20K,			/* GPIO_S0_NC[23] - XDP_OBSDATA_D3 */
...
static const struct soc_gpio_map gpscore_gpio_map[] = {
	...
	GPIO_FUNC1,		/* I2S0		GPIO_S0_SC[008]	I2S0_CLK		HDA_RST#	-		-  Unused */
	GPIO_FUNC1,		/* I2S0		GPIO_S0_SC[009]	I2S0_FRM		HDA_SYNC	-		-  Unused */
	GPIO_FUNC1,		/* I2S0		GPIO_S0_SC[010]	I2S0_DATAOUT		HDA_CLK		-		-  Unused */
	GPIO_FUNC1,		/* I2S0		GPIO_S0_SC[011]	I2S0_DATAIN		HDA_SDO		-		-  Unused */
	GPIO_NC,		/*		GPIO_S0_SC[012]	I2S1_CLK		HDA_SDI[0]	-		-  Unused */
	...
	GPIO_FUNC1,		/* I2C-3	GPIO_S0_SC[084]	SIO_I2C3_DATA		-		-		- */
	GPIO_FUNC1,		/* I2C-3	GPIO_S0_SC[085]	SIO_I2C3_CLK		-		-		- */
	GPIO_FUNC1,		/* I2C-4	GPIO_S0_SC[086]	SIO_I2C4_DATA		-		-		- */
	GPIO_FUNC1,		/* I2C-4	GPIO_S0_SC[087]	SIO_I2C4_CLK		-		-		- */
	GPIO_FUNC1,		/* I2C-5	GPIO_S0_SC[088]	SIO_I2C5_DATA		-		-		- */
	GPIO_FUNC1,		/* I2C-5	GPIO_S0_SC[089]	SIO_I2C5_CLK		-		-		- */
	GPIO_FUNC2,		/* ILB_NMI	GPIO_S0_SC[090]	SIO_I2C6_DATA		ILB_NMI		-		- */
...
static const struct soc_gpio_map gpssus_gpio_map[] = {
	...
	GPIO_INPUT_PD_20K,	/* SOC_SLEEP		GPIO_S5[06]		PMC_SUSCLK[2]		RESERVED	RESERVED	RESERVED */
	...
	GPIO_DEFAULT,		/* XDP_OBSFN_C1		GPIO_S5[22]		RESERVED		RESERVED	RESERVED	RESERVED */
	GPIO_DEFAULT,		/* XDP_OBSDATA_A0	GPIO_S5[23]		RESERVED		RESERVED	RESERVED	RESERVED */
	GPIO_DEFAULT,		/* XDP_OBSDATA_A1	GPIO_S5[24]		RESERVED		RESERVED	RESERVED	RESERVED */
	GPIO_DEFAULT,		/* XDP_OBSDATA_A2	GPIO_S5[25]		RESERVED		RESERVED	RESERVED	RESERVED */
	GPIO_DEFAULT,		/* XDP_OBSDATA_A3	GPIO_S5[26]		RESERVED		RESERVED	RESERVED	RESERVED */
	GPIO_DEFAULT,		/* XDP_OBSDATA_B0	GPIO_S5[27]		RESERVED		RESERVED	RESERVED	RESERVED */
	GPIO_DEFAULT,		/* XDP_OBSDATA_B1	GPIO_S5[28]		RESERVED		RESERVED	RESERVED	RESERVED */
	GPIO_DEFAULT,		/* XDP_OBSDATA_B2	GPIO_S5[29]		RESERVED		RESERVED	RESERVED	RESERVED */
	GPIO_DEFAULT,		/* XDP_OBSDATA_B3	GPIO_S5[30]		RESERVED		RESERVED	RESERVED	RESERVED */
